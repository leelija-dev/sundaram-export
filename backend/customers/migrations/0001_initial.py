    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('export_country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customers', to='catalog.exportcountry', verbose_name='Primary export destination')),
            ],
            options={
