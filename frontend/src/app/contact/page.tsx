      ...
      <section className="border-b border-border bg-white py-12 text-center sm:py-16 md:py-20 lg:py-24">
        <Container>
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-3 text-sm animate-fade-slide-up [animation-delay:0.15s]">
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ 24/7 trade support</span>
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ Response within 24h</span>
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ Multi‑language desk</span>
          </div>
        </Container>
      </section>
