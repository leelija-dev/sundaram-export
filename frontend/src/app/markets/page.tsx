        ...
        <Container>
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-x-2 gap-y-1.5">
              <TrustBadge className="glass-badge text-blue-700 shadow-sm animate-fade-slide-up" style={{ animationDelay: "0.2s" }}>
                24/7 trade support
              </TrustBadge>
              <TrustBadge className="glass-badge text-blue-700 shadow-sm animate-fade-slide-up" style={{ animationDelay: "0.25s" }}>
                Customs clearance ready
              </TrustBadge>
              <TrustBadge className="glass-badge text-blue-700 shadow-sm animate-fade-slide-up" style={{ animationDelay: "0.3s" }}>
                Multi‑language desk
              </TrustBadge>
            </div>
          </div>
        ...
        <Container>
          ...
          <div className="mt-20 relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-blue-500 to-accent p-8 text-center transition-all duration-500 hover:shadow-xl hover:scale-[1.01] animate-fade-slide-up glass-card" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <div className="inline-flex items-center gap-1.5 rounded-full bg-white/20 px-2 py-0.5 backdrop-blur-sm mb-4 transition-all duration-300 hover:bg-white/30">
                <GlobeAltIcon className="h-3.5 w-3.5 text-white" aria-hidden />
