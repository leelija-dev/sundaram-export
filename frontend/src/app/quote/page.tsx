      ...
      <section className="border-b border-border bg-white py-12 text-center sm:py-16 md:py-20 lg:py-24">
        <Container>
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-3 text-sm animate-fade-slide-up [animation-delay:0.15s]">
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ 24h response</span>
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ No obligation</span>
            <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">✓ Global logistics</span>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4 text-center">
              {[
                { step: "1", label: "Inquiry", icon: "📋" },
                { step: "2", label: "Logistics", icon: "✈️" },
                { step: "3", label: "Quote", icon: "📄" },
              ].map((item, idx) => (
                <div
                  key={item.step}
